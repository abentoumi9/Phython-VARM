...
individual_portfolio = ["ASML", "MSFT", "AAPL"]             #lijst maken waar stocks append kunnen worden, PER USER
...
def ViewPortfolio():
    ...
    actions_available = ["View stocks", "View balance"]
    teller = 0
    SumPortfolio = 0
    for s in actions_available:
        print(teller, ":", s)
        teller += 1
